...
public class RecruitmentCandidateTab {
	
	public RecruitmentCandidateTab(WebDriver diver) {
	...
	@FindBy(xpath = "//input[@fdprocessedid='fvasfl']")
	WebElement inputBox;
    ...
    public void addNewCandidate(){
        JSONObject newCandidate = utils.loadJsonFile("./src/test/resources/addCandidate.json");
        recruitmentMenu.click();
        addButton.click();
