...
import static setup.setup_OrangeHRM.softAssert;
import static setup.setup_OrangeHRM.driver;
...
public class RecruitmentVacanciesTab {
	
	public RecruitmentVacanciesTab(WebDriver driver) {
	    ...
	    public void addNewVacancy() {
	    	JSONObject newVacancy = utils.loadJsonFile("./src/test/resources/addVacancy.json");
	        recruitmentMenu.click();
	        vacanciesPage.click();
	        addButton.click();
