...
import static setup.setup_OrangeHRM.*;
...
public class loginPage {
	...
	@FindBy(css ="[type=submit]")WebElement btnLogin;
	@FindBy(tagName = "p")WebElement lvlInvalidCreds;
	@FindBy(tagName = "span")WebElement withoutCreds;
	@FindBy(tagName = "h6")WebElement dashboard;
	@FindBy(xpath = "//span[contains(@class,'oxd-userdropdown-tab')]")WebElement profileDropDown;
